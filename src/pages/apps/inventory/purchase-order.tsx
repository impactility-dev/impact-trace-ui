...
function ReactTable({ columns, data }: Props) {
  ...
  const handleAddPurchaceOrder = () => {
    history(`/apps/inventory/create-purchase-order`);
  };
    ...
    <>
      ...
      <Stack direction={matchDownSM ? 'column' : 'row'} spacing={1} justifyContent="space-between" alignItems="center" sx={{ p: 3, pb: 3 }}>
        ...
        <Stack direction={matchDownSM ? 'column' : 'row'} alignItems="center" spacing={matchDownSM ? 1 : 0}>
          ...
          <Button variant="contained" startIcon={<PlusOutlined />} onClick={handleAddPurchaceOrder}>
          Add Purchase Order
        </Button>
        </Stack>
      </Stack>
