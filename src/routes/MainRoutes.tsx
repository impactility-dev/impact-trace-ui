...
//product
const AppProductList = Loadable(lazy(() => import('pages/apps/products/product-list')));
const AppAddProduct = Loadable(lazy(() => import('pages/apps/products/add-product')));

//Inventory
const AppPurchaseOrder = Loadable(lazy(() => import('pages/apps/inventory/purchase-order')));
const AppInvoices = Loadable(lazy(() => import('pages/apps/inventory/invoices')));
const CreatePurchaseOrder = Loadable(lazy(()=> import('pages/apps/inventory/purchase-order/create-purchase-order')));
const CreateInvoice = Loadable(lazy(()=> import('pages/apps/inventory/purchase-order/create-invoice')));

//Partners
const Partners = Loadable(lazy(()=> import('pages/apps/partners/index')));
